...
using HardwareUniqueId = std::array<std::uint8_t, 6>;

class IDeviceUniqueSource {
public:
    virtual ~IDeviceUniqueSource() = default;
    virtual HardwareUniqueId readHardwareUniqueId() const noexcept = 0;
};
