# LAB 03A — M03-1883 / MQTT TCP plano sin TLS y sin autenticación
...
Validar el escenario `M03-1883` dentro de la familia LAB 03 MQTT.
...
Este sublaboratorio cubre `M03-1883`: MQTT TCP plano sin TLS y sin autenticación.
...
- Evidencia agregada de gates en `../evidence/lab03_static_gates.txt`.
