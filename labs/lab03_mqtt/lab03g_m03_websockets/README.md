# LAB 03G — MQTT over WebSockets / WS y WSS

**Estado:** PENDIENTE
**Escenario:** M03-8080 / M03-8081 / M03-8090 / M03-8091
...
Cubrir MQTT sobre WebSockets, WebSockets Secure y autenticación sobre ambos transportes.
...
- Conectividad Wi-Fi se incorporará únicamente cuando se valide MQTT sobre WS/WSS real.

## Alcance

Este directorio contiene el contrato, la implementación y las evidencias propias del escenario `M03-8080 / M03-8081 / M03-8090 / M03-8091`.
