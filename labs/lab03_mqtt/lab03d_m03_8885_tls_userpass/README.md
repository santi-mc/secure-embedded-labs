...
Validar usuario/password sobre canal TLS con redacción de secretos.
...
- Conectividad Wi-Fi se incorporará únicamente cuando se valide MQTT/TLS real con usuario/password.

## Alcance

Este directorio contiene el contrato, la implementación y las evidencias propias del escenario `M03-8885`.
