...
Validar la combinación TLS + autenticación por usuario/password.
...
Este sublaboratorio cubre `M03-8885` sobre `test.mosquitto.org`, puerto `8885`, TLS `true` y autenticación `username/password`.
...
- Evidencia TLS + auth cuando exista.
