# LAB 03C — M03-8883/M03-8886 / TLS con validación de servidor
...
Validar TLS de servidor y política de CA antes de tratar autenticación de aplicación.
...
- Conectividad Wi-Fi se incorporará únicamente cuando se valide conexión MQTT/TLS real.

## Alcance

Este directorio contiene el contrato, la implementación y las evidencias propias del escenario `M03-8883 / M03-8886`.
