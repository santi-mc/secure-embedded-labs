...
Demostrar que autenticación sin TLS no protege credenciales ni confidencialidad.
...
- ESP32-S3 compatible con ESP-IDF para la futura validación dry-run/consola.
- Consola USB Serial/JTAG operativa.
- No requiere todavía conexión real a `test.mosquitto.org`.

## Alcance

Este directorio contiene el contrato, la implementación y las evidencias propias del escenario `M03-1884`.
