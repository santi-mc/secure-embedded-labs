# LAB 03B — M03-1884 / MQTT TCP plano con autenticación
...
Demostrar que usuario/password sin TLS no aporta confidencialidad.
...
Este sublaboratorio cubre `M03-1884` sobre `test.mosquitto.org`, puerto `1884`, TLS `false` y autenticación `username/password`.
...
```powershell
# PENDIENTE: definir cuando exista firmware propio.
```
...
- `evidence/lab03_m03_1884_console.log` cuando exista.
