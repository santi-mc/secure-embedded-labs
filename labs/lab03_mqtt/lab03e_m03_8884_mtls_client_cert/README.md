...
Validar autenticación mutua con certificado cliente sin versionar claves privadas reales.
...
Este sublaboratorio cubre `M03-8884` sobre `test.mosquitto.org`, puerto `8884`, TLS `true` y autenticación `client certificate`.
