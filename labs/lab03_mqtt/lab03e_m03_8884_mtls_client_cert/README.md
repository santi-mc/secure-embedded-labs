# LAB 03E — M03-8884 / MQTT con certificado cliente mTLS
...
Validar el escenario `M03-8884` dentro de la familia LAB 03 MQTT.
...
Este sublaboratorio cubre `M03-8884`: MQTT con certificado cliente mTLS.
