...
Validar autenticación de cliente mediante certificado sin versionar claves privadas reales.
...
- Medio seguro para manejar certificados de cliente de prueba cuando se implemente mTLS.

## Alcance

Este directorio contiene el contrato, la implementación y las evidencias propias del escenario `M03-8884`.
