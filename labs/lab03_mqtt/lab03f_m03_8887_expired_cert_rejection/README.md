...
Demostrar que rechazar un certificado expirado es el comportamiento correcto.
...
Este sublaboratorio cubre `M03-8887` sobre `test.mosquitto.org`, puerto `8887`, TLS `true` y autenticación `false`.
...
- Evidencia de rechazo TLS cuando exista.
