# LAB 03F — M03-8887 / Rechazo de certificado servidor expirado
...
Validar el escenario `M03-8887` dentro de la familia LAB 03 MQTT.
...
Este sublaboratorio cubre `M03-8887`: Rechazo de certificado servidor expirado.
